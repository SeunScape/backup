...
export default function Register() {
    return (
        <div>
            ...
            placeholder="Username" id="userName" onChange="{this.handleChange}"></input>
            ...
            placeholder="Email Address" id="regEmail" onChange="{this.handleChange}"></input>
            ...
            placeholder="Password" id="regPassword" onChange="{this.handleChange}"></input>
